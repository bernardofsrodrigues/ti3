...
SECRET_KEY = 'django-insecure-*&mk&)6_aaf9_%n6y&weqjnwx(0%v$o)#pss8shz=4*5#!n#f%'
...
ROOT_URLCONF = 'fazenda_inteligente.urls'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=99999),  # ou timedelta(days=365 * 100)
